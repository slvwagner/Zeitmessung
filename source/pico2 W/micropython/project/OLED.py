...
WAGNIUS_LOGO_W = 64
WAGNIUS_LOGO_H = 64
# Monochrome splash derived from source/OS_support/wagnius.png.
# Blue pixels become white on the OLED, everything else stays black.
WAGNIUS_LOGO = bytes((
    0x00, 0x00, 0x00, 0x7F, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xFF, 0xFF, 0xE0, 0x00, 0x00,
    ...
    0x03, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC0, 0x03, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xC0,
    0x07, 0xFF, 0xFF, 0xFF, 0xFE, 0x7F, 0xFF, 0xE0, 0x0F, 0xFF, 0xFF, 0xFF, 0xFE, 0x3F, 0xFF, 0xF0,
    0x0F, 0xFF, 0xFF, 0xFF, 0xFC, 0x1F, 0xFF, 0xF0, 0x1F, 0xFF, 0xFF, 0xFF, 0xFC, 0x1F, 0xFF, 0xF8,
    0x1F, 0xFF, 0xFF, 0xFF, 0xF8, 0x0F, 0xFF, 0xF8, 0x3F, 0xFF, 0xFF, 0xFF, 0xF8, 0x0F, 0xFF, 0xFC,
    0x3F, 0xFF, 0xFF, 0xFF, 0xF0, 0x07, 0xFF, 0xFC, 0x3F, 0xFF, 0xFF, 0xFF, 0xF0, 0x07, 0xFF, 0xFC,
    0x7F, 0xFF, 0xFF, 0xFF, 0xE0, 0x03, 0xFF, 0xFE, 0x7F, 0xFF, 0xFF, 0xFF, 0xE0, 0x03, 0xFF, 0xFE,
    0x7F, 0xFF, 0xFF, 0xFF, 0xC0, 0x01, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x00, 0xFF, 0xFF,
    ...
    0xFF, 0xFC, 0x7F, 0xFE, 0x7F, 0xFF, 0x3F, 0xFF, 0xFF, 0xF8, 0x7F, 0xFC, 0x3F, 0xFE, 0x1F, 0xFF,
    0xFF, 0xF8, 0x3F, 0xFC, 0x3F, 0xFC, 0x1F, 0xFF, 0xFF, 0xF0, 0x3F, 0xF8, 0x1F, 0xFC, 0x0F, 0xFF,
    0xFF, 0xF0, 0x1F, 0xF0, 0x0F, 0xF8, 0x0F, 0xFF, 0xFF, 0xE0, 0x1F, 0xF0, 0x0F, 0xF8, 0x07, 0xFF,
    0xFF, 0xE0, 0x0F, 0xE0, 0x07, 0xF0, 0x03, 0xFF, 0xFF, 0xC0, 0x0F, 0xE0, 0x07, 0xF0, 0x03, 0xFF,
    0xFF, 0x80, 0x07, 0xC0, 0x03, 0xE0, 0x01, 0xFF, 0x7F, 0x80, 0x07, 0xC0, 0x03, 0xE0, 0x01, 0xFE,
    0x7F, 0x00, 0x03, 0x80, 0x01, 0xC0, 0x00, 0xFE, 0x7F, 0x00, 0x01, 0x80, 0x01, 0xC0, 0x00, 0xFE,
    0x3E, 0x00, 0x01, 0x00, 0x00, 0x80, 0x00, 0x7C, 0x3F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFC,
    ...
    0x00, 0x00, 0x03, 0xFF, 0xFF, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0xFE, 0x00, 0x00, 0x00
))
...
class OLED_I2C_SLOW:
    ...
    def blit(self, fbuf, x, y, key=-1, palette=None): self.fb.blit(fbuf, x, y, key, palette)
...
def _show_startup_splash(duration_ms=OLED_SPLASH_MS):
    if not have_real_oled():
        return
    logo_fb = framebuf.FrameBuffer(bytearray(WAGNIUS_LOGO), WAGNIUS_LOGO_W, WAGNIUS_LOGO_H, framebuf.MONO_HLSB)
    x = (OLED_WIDTH - WAGNIUS_LOGO_W) // 2
    y = (OLED_HEIGHT - WAGNIUS_LOGO_H) // 2
    oled.fill(0)
    oled.blit(logo_fb, x, y)
    oled.show()
    if duration_ms:
