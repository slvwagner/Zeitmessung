<?php
// insert_race_v3.php — inserts a row into `race` (with robust API key debug)
...
// ===== QUICK PING (confirms this exact file is running) =====
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'GET' && isset($_GET['ping'])) {
    $hdrs = function_exists('getallheaders') ? getallheaders() : [];
    echo json_encode([
        'ok' => true,
        'msg' => 'insert_race_v3 alive',
        'version' => 'v3-debug',
...
// ===== AUTH (header OR JSON OR GET — debug-friendly) =====
$hdrs = function_exists('getallheaders') ? getallheaders() : [];
$received = '';
